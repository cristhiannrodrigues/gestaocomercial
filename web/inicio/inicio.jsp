...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <%@include file="../menu/menuInicio.html" %>
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge">CL/FN</div>
                                            <div>Clientes e Fornecedores</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="../clientes_fornec/clientes_fornec.jsp">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge">Colaboradores</div>
                                            <div>Gerenciar Colaboradores</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="../colaboradores/colaboradores.jsp">
                                    <div class="panel-footer">
                                        <span class="pull-left">Acessar</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
