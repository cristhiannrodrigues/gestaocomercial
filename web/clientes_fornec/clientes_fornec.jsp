...
<html lang="en">
    ...
    <head>
        ...
        <title>CL/FN - Sistema de Gestão Comercial</title>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- Navigation -->
            <%@include file="../menu/menuClientes_Fornec.html" %>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Clientes e Fornecedores</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                            ...
                                            <form role="form">
                                                ...
                                                <div class="col">
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input maxlength="14" type="text" class="form-control" placeholder="CPF/CNPJ">
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="col">
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Endereço">
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
